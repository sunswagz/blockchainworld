...
const HALLS = ["kinh-thanh", "dai-quan-trac", "do-sat-vien", "cong-bo", "ho-bo", "tang-thu-cac", "hoang-thanh", "tao-bien-xu", "tu-cam-thanh", "thai-boc-tu", "kham-thien-giam", "thi-bac-ty"];

/* `tu-cam-thanh-runtime/`, `kham-thien-giam-runtime/` và
   `thi-bac-ty-runtime/` KHÔNG có ở đây và không được thêm vào. Cả ba là
