/* ═══════════════════════════════════════════════════════
   Service worker — Khâm Thiên Giám
   Chiến lược:
     · vỏ ứng dụng (html/css/js/icon) : cache trước, chạy offline
     · phông chữ Google              : cache khi dùng lần đầu
     · assets/js/v/                  : MẠNG TRƯỚC

   `assets/js/phong.js` là sổ bảy phòng VIẾT TAY, đổi cùng nhịp với
   mã, nên nó nằm thẳng trong SHELL.

   Nhưng `assets/js/v/dai-chiem.js` thì ngược hẳn: runtime Python ghi
