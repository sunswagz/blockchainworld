...
/* Thang bằng chứng và bảy tiêu chí đã chuyển sang assets/js/khung.js
   — chúng là lớp PHƯƠNG PHÁP, dùng chung cho mọi chủ thể. Giữ một
   bản ở đây nữa thì hai bản sẽ lệch sau vài lần sửa, và lúc đó mọi
   so sánh hình dạng bảng chấm giữa các nước thành vô nghĩa. */
...
window.DQT_SOI = { SOI: SOI, DANHSACH: DANHSACH };
})();
