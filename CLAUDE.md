...
mà sai cổng" rất dễ sót.
    ...
    python scripts/selftest.py    1448 phép kiểm số học, KHÔNG cần mạng
    ...
    python scripts/quet-dot-bien.py --file=kham/tien_hoa.py  36 con: 16 chết, 20 CÒN NỢ
    ...
    python scripts/selftest.py    1976 phép kiểm số học, KHÔNG cần mạng
...
không chạy được thứ đó, nên chạy tay ở máy rồi commit lát cắt.
    ...
    python scripts/selftest.py    467 phép kiểm số học, KHÔNG cần mạng
