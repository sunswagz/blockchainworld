...
mà sai cổng" rất dễ sót.
    ...
    python scripts/selftest.py    1455 phép kiểm số học, KHÔNG cần mạng
    ...
    python scripts/selftest.py    1981 phép kiểm số học, KHÔNG cần mạng
...
không chạy được thứ đó, nên chạy tay ở máy rồi commit lát cắt.
    ...
    python scripts/selftest.py    481 phép kiểm số học, KHÔNG cần mạng
