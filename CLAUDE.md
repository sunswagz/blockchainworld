...
mà sai cổng" rất dễ sót.
    ...
    python scripts/selftest.py    1119 phép kiểm số học, KHÔNG cần mạng
    python scripts/quet-dot-bien.py --file=kham/dat_lenh.py  21 con: 13 chết, 8 tương đương
    ...
    python scripts/quet-dot-bien.py --file=kham/ket_toan.py  16 con: 10 chết, 6 tương đương
    python scripts/quet-dot-bien.py --file=kham/cham_moc.py  12 con: 7 chết, 5 tương đương
    python scripts/quet-dot-bien.py --file=kham/kho_doi.py   27 con: 19 chết, 8 tương đương
    ...
    python scripts/selftest.py    1915 phép kiểm số học, KHÔNG cần mạng
...
không chạy được thứ đó, nên chạy tay ở máy rồi commit lát cắt.
    ...
    python scripts/selftest.py    462 phép kiểm số học, KHÔNG cần mạng
