...
mà sai cổng" rất dễ sót.
    ...
    python scripts/selftest.py    847 phép kiểm số học, KHÔNG cần mạng
    ...
    python scripts/selftest.py    1823 phép kiểm số học, KHÔNG cần mạng
...
không chạy được thứ đó, nên chạy tay ở máy rồi commit lát cắt.
    ...
    python scripts/selftest.py    418 phép kiểm số học, KHÔNG cần mạng
