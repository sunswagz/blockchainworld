...
mà sai cổng" rất dễ sót.
    ...
    python scripts/selftest.py    1232 phép kiểm số học, KHÔNG cần mạng
    python scripts/quet-dot-bien.py --file=kham/chien_thuat.py 22 con: 7 chết, 15 CÒN NỢ
    ...
    python scripts/selftest.py    1929 phép kiểm số học, KHÔNG cần mạng
