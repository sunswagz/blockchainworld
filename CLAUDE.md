...
mà sai cổng" rất dễ sót.
    ...
    python scripts/selftest.py    1982 phép kiểm số học, KHÔNG cần mạng
    ...
    python scripts/quet-dot-bien.py --file=kham/so_phan_doan.py 13 con: 12 chết, 1 tương đương
    python scripts/quet-dot-bien.py --file=kham/ho_market.py   1 con: 1 chết, 0 sống
    ...
    python scripts/quet-dot-bien.py --file=kham/dinh_gia.py  33 con: 19 chết, 14 CÒN NỢ
    ...
    # ── QUÉT ĐỘT BIẾN ────────────────────────────────────────────────
    #
    # 28 module · 529 con · 297 chết (56%) · 232 còn sống.
    #
...
không chạy được thứ đó, nên chạy tay ở máy rồi commit lát cắt.
    ...
    python scripts/selftest.py    518 phép kiểm số học, KHÔNG cần mạng
...
Từ 04/09/2026 nó mang **bí danh `cong-thanh`** và đi đúng đường mọi
